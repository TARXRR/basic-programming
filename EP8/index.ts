const perSoNalInForMaTionn  = {
    fullName: 'Panuwit Kanason',
    adDress: '115/5' ,
    swine: '8',
    road: 'road 66',
    districts: 'Delaware',
    ...
    ciTy: 'America',
    zipCode:'152478',
    email:'Uini1554@gmail.com',
    friend : {
        firstname : 'Tanaphat Tengon',
        lastName : 'Pam',
        age : '19',
        animal : {
            animalType : 'dog',
...
const myFriendsAKA = myFriends.map(function(element, inbox) {
    return ({
...
const myFriendsMoreThan = myFriends.filter(function(element,index) {
    return element.age > 19 && element.lastname === 'baron'
})
...
const database = [
    ...
    const covidDeath = database.filter(function(element,inbox) {
